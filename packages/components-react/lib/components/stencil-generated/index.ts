...
export const IfxDropdownSeparator = /*@__PURE__*/createReactComponent<JSX.IfxDropdownSeparator, HTMLIfxDropdownSeparatorElement>('ifx-dropdown-separator');
export const IfxDropdownTrigger = /*@__PURE__*/createReactComponent<JSX.IfxDropdownTrigger, HTMLIfxDropdownTriggerElement>('ifx-dropdown-trigger');
...
export const IfxIconButton = /*@__PURE__*/createReactComponent<JSX.IfxIconButton, HTMLIfxIconButtonElement>('ifx-icon-button');
export const IfxIconsPreview = /*@__PURE__*/createReactComponent<JSX.IfxIconsPreview, HTMLIfxIconsPreviewElement>('ifx-icons-preview');
export const IfxLink = /*@__PURE__*/createReactComponent<JSX.IfxLink, HTMLIfxLinkElement>('ifx-link');
